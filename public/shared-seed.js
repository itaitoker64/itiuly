/* התוכנית המשותפת לשבועיים הראשונים */
window.SHARED_SEED = {
  ...
  },
  {
   ...
   "rows": [
    ...
    },
    {
     ...
     "cat": "אחר",
     "baht": null,
     "status": "ממתינים לפרטי בנק ולתשלום מקדמה",
    ...
    },
    {
     "time": "",
     "dur": "",
     "act": "חבילת KYN — דירה, ארוחות ואימונים לשניים",
 ...
 "bookings": [
  ...
  {
   "id": "kyn-2026-11",
   "what": "KYN Phoenix Muay Thai",
   "when": "26–29/11/2026",
   "details": "Panoramic Sunset View A/C Apartment · שני אנשים, שניהם מתאמנים · 3 לילות. נשלחה בקשה להתקדם; ממתינים לפרטי בנק ולתשלום מקדמה",
   "ref": "טרם התקבל אישור סופי",
   "payment": "฿3,800 לדירה ללילה כולל לינה, ארוחות ואימון לאדם אחד; לאדם השני ฿660 אימון + ฿400 ארוחות ליום. אומדן לשלושה לילות ושלושה ימי תוספת: ฿14,580; מקדמה 50%: ฿7,290. נשלחה בקשה להתקדם; טרם שולם. הסכום הסופי וכיסוי יום העזיבה טעונים אישור.",
   "freeCancel": "תנאי ביטול והחזר מקדמה טעונים אישור"
  }
 ],
 "hotels": [
  {
  ...
  },
  {
   ...
   "what": "฿3,800 לדירה ללילה כולל לינה, ארוחות ואימון לאדם אחד; לאדם השני ฿660 אימון + ฿400 ארוחות ליום. אומדן לשלושה לילות ושלושה ימי תוספת: ฿14,580; מקדמה 50%: ฿7,290. נשלחה בקשה להתקדם; טרם שולם. הסכום הסופי וכיסוי יום העזיבה טעונים אישור.",
   "perNight": 4860,
   "choice": "ממתינים לפרטי בנק ולתשלום מקדמה",
   "freeCancel": "לברר תנאי ביטול והחזר מקדמה",
   "link": "אתר המחנה",
